...
## slider の解決策 - 拡張boot 領域 -

この問題を解決するために、slider では boot 領域を FAT32に拡張し、PC と共用して利用できるようにしてあります  
取得したセンサデータや撮影した画像などをこちらに保存すると PC から読み取ることができます

<img src="pic/ss.2016-12-11 17.10.57.png" width="75%">

また、WiFi の設定や、センサデータの取得時間間隔の設定などもこちらの領域に用意し、PC から設定ができるようにしてあります  
詳細は [処理間隔の設定](cron.md) 及び [WiFiアクセスポイント設定](addwpa.md) をご参照ください 
